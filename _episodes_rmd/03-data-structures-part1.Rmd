...
nordic$lifeExp
```
Note that when you type '$' after the data frame variable name, the column names will pop up as suggestions. You can also explore the data frame using 'r head' and 'r names' functions:

...
> > Answer b will correctly load the ggplot2 package. Note there are quotation marks.
> > Answer c will correctly load the ggplot2 package. Note there are no quotation marks.

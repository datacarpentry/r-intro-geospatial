...
a vector of strings labelling nordic countries for all the countries in our
study:
...
When doing statistical modelliing, it's important to know what the baseline
levels are. This is assumed to be the first factor, but by default factors are
labelled in alphabetical order. You can change this by specifying the levels:
